...
// 获取招租列表
infomation.issueList = function (page, limit, type, house_type, areas_id, min_price, max_price) {
    return new Promise((resolve, reject) => {
...
// 获取招租列表--详情
infomation.msgDetail = function (id) {
    return new Promise((resolve, reject) => {
        api.get(api.baseUrl.host, api.url.MsgDetail, {
            id: id
        }, function (response) {
            if (response.msg === 'ok') {
                var res = response.data;
